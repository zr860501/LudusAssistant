...
event=read('app/src/main/java/com/ludusassistant/app/data/EventStore.java')
ocr=read('app/src/main/java/com/ludusassistant/app/vision/OcrEngine.java')
main=read('app/src/main/java/com/ludusassistant/app/MainActivity.java')
obs=read('app/src/main/java/com/ludusassistant/app/data/ObservationEngine.java')
capture=read('app/src/main/java/com/ludusassistant/app/capture/CaptureService.java')
parser=read('app/src/main/java/com/ludusassistant/app/vision/parser/ScreenTextParser.java')
receiver=read('app/src/main/java/com/ludusassistant/app/data/RefreshReceiver.java')
gradle=read('app/build.gradle')
manifest=read('app/src/main/AndroidManifest.xml')
appstore=read('app/src/main/java/com/ludusassistant/app/data/AppStore.java')
